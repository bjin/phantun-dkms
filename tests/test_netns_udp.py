...
def test_netns_all_four_channels(phantun_module, vm):
    ...
    channels = [
        {'src_port': PORTS_A[0], 'dst_port': PORTS_B[0], 'dst_addr': NS_ADDR_B, 'message': 'chan-2222-3333'},
        {'src_port': PORTS_A[0], 'dst_port': PORTS_B[1], 'dst_addr': NS_ADDR_B, 'message': 'chan-2222-5555'},
        {'src_port': PORTS_A[1], 'dst_port': PORTS_B[0], 'dst_addr': NS_ADDR_B, 'message': 'chan-4444-3333'},
        {'src_port': PORTS_A[1], 'dst_port': PORTS_B[1], 'dst_addr': NS_ADDR_B, 'message': 'chan-4444-5555'},
    ]
    servers = [
        spawn_netns_scenario(
            vm,
